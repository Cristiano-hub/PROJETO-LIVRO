# Projeto Livro – Engenharia de Inteligência Artificial

Este projeto é uma página web para divulgação do livro **Engenharia de Inteligência Artificial**.
...
<img src="img/autorx.jpg" alt="Foto do Autor" width="180">
